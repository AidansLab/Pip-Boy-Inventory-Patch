(function() {
  ...
  const ICONS = {
    ...
    bleed: atob("BwyBAAAgQcPLl8/f/fHA"),
	energy: atob("BwyBADzx44ffvwwwYIAA"),
	fire: atob("CgyBAAgCAZB8X7/vu8fhsGYYAA=="),
    frost: atob("Dw+BAAEAAgAVABwAEASpBOR//xOQSpAEABwAVAAgAEAA"),
	rad: atob("EA+BABAIOBx8Pnw+/n7+f/2/AYAAAAGAA8AH4AfgD/ADwA=="),
    ammo: atob("EhOBAAAAB/53/5//53/5x/5wAAB/53/5//53/5x/5wAAB/53/5//53/5x/5wAAA="),
	time: atob("FRWBAAA8AAP4AAngAMOABg4CMDkMgNgwBsDgHgfA8B4HgPA8AwGgABmAAM4ADjAA4OAOA8HgD/4AD4AA"),
